  ...
  return (
    <main style={{ padding: 32, fontFamily: "system-ui, -apple-system, Segoe UI, Roboto" }}>
      <div style={{ maxWidth: 920, margin: "0 auto" }}>
        ...
        <ol style={{ marginTop: 22, lineHeight: 1.7, opacity: 0.9 }}>
          <li>Le cabinet publie le certificat (PDF) via son espace.</li>
          <li>Le système génère une preuve d’intégrité et d’horodatage.</li>
          <li>Le client vérifie via un lien ou QR code.</li>
        </ol>
      </div>
    </main>
  );
